...
from spd_learn.modules import SPDBatchNorm
...
# Apply SPDBatchNorm
bn = SPDBatchNorm(num_features=2, momentum=0.1, affine=False)
bn.train()
Y = bn(X)
...
ax1.set_title("Before SPDBatchNorm\n(Scattered)", fontweight="bold")
...
plt.suptitle(
    "SPDBatchNorm: Riemannian Batch Normalization", fontsize=13, fontweight="bold"
)
plt.tight_layout()
plt.show()
