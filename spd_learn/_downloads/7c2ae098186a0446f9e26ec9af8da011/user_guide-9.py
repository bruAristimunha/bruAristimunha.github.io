...
from spd_learn.functional import airm_distance, airm_geodesic, frechet_mean
...
X_spd, y = make_gaussian_blobs(
    n_matrices=15, n_dim=2, class_sep=1.5, class_disp=0.5, random_state=42, n_jobs=1
)
...
# Compute class means using Log-Euclidean Frechet mean
mean0 = frechet_mean(X_class0)
mean1 = frechet_mean(X_class1)
...
plt.suptitle(
    "AIRM Geodesics: Shortest Paths on the SPD Manifold", fontsize=14, fontweight="bold"
)
plt.tight_layout()
plt.show()
